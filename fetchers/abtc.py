"""
American Battery Technology 官網爬蟲
"""
...
class AbtcFetcher(CompanyFetcher):
    """American Battery Technology 爬蟲"""

    company_id = "abtc"
    company_name = "American Battery Technology"
    news_url = "https://www.americanbatterytechnology.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.americanbatterytechnology.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from American Battery Technology")
        return documents
