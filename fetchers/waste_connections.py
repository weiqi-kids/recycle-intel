...
class WasteConnectionsFetcher(CompanyFetcher):
    """Waste Connections 爬蟲"""

    company_id = "waste_connections"
    company_name = "Waste Connections"
    news_url = "https://www.wasteconnections.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.wasteconnections.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Waste Connections")
        return documents
...
if __name__ == "__main__":
    fetcher = WasteConnectionsFetcher()
