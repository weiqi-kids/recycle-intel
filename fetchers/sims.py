...
class SimsFetcher(CompanyFetcher):
    """Sims Limited 爬蟲"""

    company_id = "sims"
    company_name = "Sims Limited"
    news_url = "https://www.simslimited.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.simslimited.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Sims Limited")
        return documents
