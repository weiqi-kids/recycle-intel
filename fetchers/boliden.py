...
class BolidenFetcher(CompanyFetcher):
    """Boliden 爬蟲"""

    company_id = "boliden"
    company_name = "Boliden"
    news_url = "https://www.boliden.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Boliden")
        return documents
