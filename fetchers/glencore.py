...
class GlencoreFetcher(CompanyFetcher):
    """Glencore 爬蟲"""

    company_id = "glencore"
    company_name = "Glencore"
    news_url = "https://www.glencore.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.glencore.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Glencore")
        return documents
