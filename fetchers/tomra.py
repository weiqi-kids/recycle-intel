...
class TomraFetcher(CompanyFetcher):
    """TOMRA Systems 爬蟲"""

    company_id = "tomra"
    company_name = "TOMRA Systems"
    news_url = "https://www.tomrasystems.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.tomrasystems.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from TOMRA Systems")
        return documents
