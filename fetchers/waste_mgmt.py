...
class WasteMgmtFetcher(CompanyFetcher):
    """Waste Management 爬蟲"""

    company_id = "waste_mgmt"
    company_name = "Waste Management"
    news_url = "https://www.wastemanagement.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.wastemanagement.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Waste Management")
        return documents
