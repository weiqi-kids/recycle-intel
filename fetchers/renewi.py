...
class RenewiFetcher(CompanyFetcher):
    """Renewi 爬蟲"""

    company_id = "renewi"
    company_name = "Renewi"
    news_url = "https://www.renewi.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Renewi")
        return documents
