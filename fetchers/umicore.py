...
class UmicoreFetcher(CompanyFetcher):
    """Umicore 爬蟲"""

    company_id = "umicore"
    company_name = "Umicore"
    news_url = "https://www.umicore.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Umicore")
        return documents
