...
class AurubisFetcher(CompanyFetcher):
    """Aurubis 爬蟲"""

    company_id = "aurubis"
    company_name = "Aurubis"
    news_url = "https://www.aurubis.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Aurubis")
        return documents
