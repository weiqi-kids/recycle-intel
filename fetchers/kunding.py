...
class KundingFetcher(CompanyFetcher):
    """崑鼎投資控股 爬蟲"""

    company_id = "kunding"
    company_name = "崑鼎投資控股"
    news_url = "https://www.崑鼎投資控股.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from 崑鼎投資控股")
        return documents
