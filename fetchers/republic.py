...
class RepublicFetcher(CompanyFetcher):
    """Republic Services 爬蟲"""

    company_id = "republic"
    company_name = "Republic Services"
    news_url = "https://www.republicservices.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.republicservices.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Republic Services")
        return documents
